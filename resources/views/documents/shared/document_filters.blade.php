...
<x-form.filter>
    <div class="row">
        ...
        <div class="col-12 col-sm-6 col-xl-3">
            <x-bs::form.field id="reference_type" name="filter[reference_type]" type="select"
                              :options="Options::fromEnum($documentReferenceTypes, 'getTranslatedName')->prepend(__('all'), FilterValue::All->value)"
                              :from-query="true">{{ __('Document related to') }}</x-bs::form.field>
        </div>
        <div class="col-12 col-sm-6 col-xl-3">
